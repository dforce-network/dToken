...
contract DTokenHP is ReentrancyGuard, Pausable, ERC20SafeTransfer {
        ...
        whenNotPaused
    {
        ...
        _redeemLocal.originationFee = originationFee[DTokenHP(this)
            .redeem
            .selector];
   ...
   */
        ...
        )
    {
        ...
        return (
            decimals,
            getCurrentExchangeRate(),
            originationFee[DTokenHP(this).mint.selector],
            originationFee[DTokenHP(this).redeem.selector],
            _tokenTotalBalance
        );
    }
