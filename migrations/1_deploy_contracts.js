...
var dTokenAddresses = artifacts.require("dTokenAddresses.sol");
...
module.exports = async function (deployer) {
    ...
    // Deploys dUSDC
    await deployer.deploy(DToken, "dUSDC", "dUSDC", usdc.address, usdc_dispatcher.address);
    ...
    await dUSDC_proxy.initialize("dUSDC", "dUSDC", usdc.address, usdc_dispatcher.address);
    ...
    // Deploys dUSDT
    await deployer.deploy(DToken, "dUSDT", "dUSDT", usdt.address, usdt_dispatcher.address);
    ...
    await dUSDT_proxy.initialize("dUSDT", "dUSDT", usdt.address, usdt_dispatcher.address);
